...
!!! tip
    You can find an [example workflow for GitHub Actions](https://github.com/cedx/coveralls.dart/blob/master/.github/workflows/ci.yaml) in the sources of this project.
