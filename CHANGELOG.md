...
## Version [5.10.0](https://github.com/cedx/coveralls.dart/compare/v5.9.0...v5.10.0)
- Raised the [Dart SDK](https://dart.dev/tools/sdk) constraint.
- Updated the package dependencies.

## Version [5.9.0](https://github.com/cedx/coveralls.dart/compare/v5.8.0...v5.9.0)
...
## Version [5.8.0](https://github.com/cedx/coveralls.dart/compare/v5.7.0...v5.8.0)
